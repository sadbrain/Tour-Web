const idBooking = document.querySelector("#form-delete-booking input[name='id']");
const userName = document.querySelector("#form-delete-booking input[name='user_name']");
const tourName = document.querySelector("#form-delete-booking input[name='tour_name']");
const booking_date = document.querySelector("#form-delete-booking input[name='booking_date']");
const status_booking = document.querySelector("#form-delete-booking input[name='status_booking']");
const total = document.querySelector("#form-delete-booking input[name='total_booking']");
const adult_quantity = document.querySelector("#form-delete-booking input[name='adult_quantity']");
const children_quantity = document.querySelector("#form-delete-booking input[name='children_quantity']");
let services;
let idUser;
let idTour
